...
const OAuth2_callback = "https://developers.google.com/oauthplayground";

const { EMAIL, CLIENT_ID, CLIENT_SECRET, MAILING_REFRESH } = process.env;
...
function sendNewSellerEmail(email, name, url) {
  auth.setCredentials({
...
module.exports = { sendNewSellerEmail };
